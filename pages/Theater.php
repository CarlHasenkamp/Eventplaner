...
<head>
    ...
    <link rel="stylesheet" href="../css/pages_css/Theater.css">
                ...
                <div class="Mikro">
                    ...
                    <div class="inhalt_checkbox_Flexcontainer">
                        ...
                        <div id="2A" class="container_moreoptions">
                            ...
                            <div class="container_moreoptions_flex">
                                <input onchange="upload('file1')" class="file" type="file" name="file_musikfile" id="file1" value=" <?php
                                                                                                                                    if (isset($_SESSION['file_musikfile']) && !empty($_SESSION['file_musikfile'])) {
                                                                                                                                        echo $_SESSION['file_musikfile'];
                                                                                                                                    } ?>">
                                <label class="input_file_data" id="output_file1" for="file1"><?php
                ...
                <div class="Mikro">
                    <div class="inhalt_checkbox_Flexcontainer">
                        ...
                        <div id="7A" class="container_moreoptions">
                            <input onchange="upload('file4')" class="file" type="file" name="file_drehbuch" id="file4" value=" <?php
                                                                                                                                if (isset($_SESSION['file_drehbuch']) && !empty($_SESSION['file_drehbuch'])) {
                                                                                                                                    echo $_SESSION['file_drehbuch'];
                                                                                                                                } ?>">
                            <label class="input_file_data" id="output_file4" for="file4"><?php

                                                                                            if (isset($_SESSION['file_drehbuch']) && !empty($_SESSION['file_musikfile'])) {
                                                                                                echo $_SESSION['file_drehbuch'];
                                                                                            } else {
                                                                                                echo 'Dateiauswahl (Max 100 Megabyte)';
                                                                                            }
