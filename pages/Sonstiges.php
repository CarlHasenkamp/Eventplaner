    ...
    <section class="inhalt">
        ...
        <form action="../includes/preload.php" method="post" enctype='multipart/form-data'>
            <div class="inhalt_container_textfeld">
                <label for="kl">Welche Art von Veranstaltung haben Sie sich überlegt?</label>
                <input type="text" id="kl" name="eventtype" class="inhalt_conatiner_textfeld_input" value="<?php

                                                                                                            if (isset($_SESSION['newvertyp'])) {
            ...
            <div class="tontechnik">
                ...
                <div class="Mikro">
                    ...
                    <div class="inhalt_checkbox_Flexcontainer">
                        <label for="2" class="inhalt_checkbox_Flexcontainer_label1_checkbox">Musik</label>
                        <input onclick="moreoptions(2)" type="checkbox" name="checkbox_musik" class="inhalt_checkbox_Flexcontainer_checkbox_box1" id="2" <?php
                                                                                                                                                            if (isset($_SESSION['checkbox_musik'])) {
                                                                                                                                                            ...
                                                                                                                                                            ?>>
                        <div id="2A" class="container_moreoptions">
                            <div class="inhalt_checkbox_Flexcontainer_label2"></div>
                            <label for="1c" class="inhalt_checkbox_Flexcontainer_label1">Hier können Sie einen Link zu Ihrer Playlist hinzufügen (z.B Spotify, Youtube...) <a style="color:#ffc000;" href="help.php">Wie geht das?</a> </label>
                            <div class="container_moreoptions_flex">

                                <input style="width:70%;" class="input_num" type="text" name="link_playlist" id="1c" value="<?php

                                                                                                                            if (isset($_SESSION['link_playlist'])) {
                                                                                                                                echo $_SESSION['link_playlist'];
                                                                                                                            }
                                                                                                                            ?>">
                            </div>

                            <label for="file1" class="inhalt_checkbox_Flexcontainer_label1">Hier können Sie eine Musik Datei einfügen. (z.B MP3 Datei)</label>
                            <div class="container_moreoptions_flex">
                                <input onchange="upload('file1'); warnung(1)" class="file" type="file" name="file_musikfile" id="file1" value=" ">
                                <label class="input_file_data" id="output_file1" for="file1"> Dateiauswahl (Max 100 Megabyte)</label>


                            </div>

                            <label for="3c" class="inhalt_checkbox_Flexcontainer_label1">Anmerkung</label>
                            <div class="container_moreoptions_flex">
                                <input style="width:70%;" class="input_num" type="text" name="anmerkung_musik" id="3c" value="<?php

                                                                                                                                if (isset($_SESSION['anmerkung_musik'])) {
                                                                                                                                    echo $_SESSION['anmerkung_musik'];
                                                                                                                                }
                                                                                                                                ?>">
                            </div>
                        </div>
            ...
            <div class="lichttechnik">
                <h2>Lichttechnik</h2>
                <div class="Mikro">
                    <div class="inhalt_checkbox_Flexcontainer">
                        <label for="folger" class="inhalt_checkbox_Flexcontainer_label1_checkbox">Spot-Light (Verfolger) <a class="link" href="https://www.thomann.de/de/showtec_followspot_led_120w.htm" target="_blank">Was ist das?</a></label>
                        <input type="checkbox" name="checkbox_verfolger" class="inhalt_checkbox_Flexcontainer_checkbox_box1" id="folger" <?php

                                                                                                                                            if (isset($_SESSION['checkbox_verfolger'])) {
                ...
                <div class="Mikro">
                    ...
                    <div class="inhalt_checkbox_Flexcontainer">
                        ...
                        <div id="5A" class="container_moreoptions">
                            <input onchange="upload('file2'); warnung(1)" class="file" type="file" name="file_ppp" id="file2" value="">
                            <label class="input_file_data" id="output_file2" for="file2">Dateiauswahl (Max 100 Megabyte)</label>
                        </div>
                    </div>
                    <div class="inhalt_checkbox_Flexcontainer">
                        ...
                        <div id="6A" class="container_moreoptions">
                            <input onchange="upload('file3'); warnung(1)" class="file" type="file" name="file_ablaufplan" id="file3" value="">
                            <label class="input_file_data" id="output_file3" for="file3">Dateiauswahl (Max 100 Megabyte)</label>
                        </div>
                    </div>
                    <div class="inhalt_checkbox_Flexcontainer">
                        <label for="7" class="inhalt_checkbox_Flexcontainer_label1_checkbox">Drehbuch für z.B das Theater</label>
                        <input onclick="moreoptions(7);" name=" checkbox_drehbuch" type="checkbox" class="inhalt_checkbox_Flexcontainer_checkbox_box1" id="7" <?php

                                                                                                                                                                if (isset($_SESSION['checkbox_drehbuch'])) {
                                                                                                                                                                    if ($_SESSION['checkbox_drehbuch'] == "on") {
                                                                                                                                                                        echo 'checked';
                                                                                                                                                                    }
                                                                                                                                                                }
                                                                                                                                                                ?>>
                        <div id="7A" class="container_moreoptions">
                            <input onchange="upload('file4'); warnung(1)" class="file" type="file" name="file_drehbuch" id="file4" value="">
                            <label class="input_file_data" id="output_file4" for="file4">Dateiauswahl (Max 100 Megabyte)</label>
                        </div>
                    </div>
                    <div class="inhalt_checkbox_Flexcontainer">
                        <label for="8" class="inhalt_checkbox_Flexcontainer_label1_checkbox">Nebelmaschine</label>
                        <input type="checkbox" name="checkbox_nebelmaschine" class="inhalt_checkbox_Flexcontainer_checkbox_box1" id="8" <?php

                                                                                                                                        if (isset($_SESSION['checkbox_nebelmaschine'])) {
            ...
            <div class="container_button">
                <button class="button_zurueck" name="btn_back" onclick="warnung(0)" type="submit" style="vertical-align:middle"><span>Zurück</span></button>
    ...
    <script>
        ...
        function warnung(x) {
            if (x == 1) {
                ...
                if (i == true) {
                    alert('Aus Sicherheitsgründen bitten wir Sie Ihre Datein, wenn Sie zurückkehren, erneut hochzuladen');
                }
            }
        }
